...
import { INCOME_CATEGORIES, INCOME_CATEGORY_COLORS, IncomeCategory } from '../data/mockData';
...
export function Income() {
  const { incomeTransactions, addTransaction, deleteTransaction, totalIncome, currentMonthIncome } = useData();
  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1500px] mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {[
          { label: 'Total Income (All Time)', value: fmt(totalIncome), color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
          { label: 'This Month', value: fmt(currentMonthIncome), color: 'text-indigo-600 dark:text-indigo-400', bg: 'bg-indigo-500/10', border: 'border-indigo-500/20' },
          { label: 'This Year (2026)', value: fmt(thisYearIncome), color: 'text-teal-600 dark:text-teal-400', bg: 'bg-teal-500/10', border: 'border-teal-500/20' },
        ].map(item => (
          <div
            key={item.label}
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-border bg-card p-6 shadow-sm h-fit">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-card-foreground">Add New Income</h2>
          </div>
            ...
            {filteredSorted.length === 0 ? (
              <div className="rounded-2xl border border-border bg-card flex flex-col items-center justify-center py-20 text-center shadow-sm">
                ...
                <p className="text-[16px] font-bold text-card-foreground mb-1">
                  {searchQuery || categoryFilter !== 'All' ? 'No results found' : 'No income entries yet'}
                </p>
              ...
              filteredSorted.map(tx => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: `${INCOME_CATEGORY_COLORS[tx.category as IncomeCategory]}20` }}
                  >
                    <TrendingUp size={20} style={{ color: INCOME_CATEGORY_COLORS[tx.category as IncomeCategory] }} />
                  </div>
                    ...
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          color: INCOME_CATEGORY_COLORS[tx.category as IncomeCategory],
