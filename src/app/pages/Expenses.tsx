...
export function Expenses() {
  ...
  const avgMonthlyExpense =
    expenseTransactions.length > 0 ? totalExpenses / 5 : 0;
  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1500px] mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      {(isOverspending || isNearLimit) && (
        ...
        >
          <div
            className={`mt-0.5 w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isOverspending ? "bg-destructive/20 text-destructive" : "bg-amber-500/20 text-amber-600 dark:text-amber-400"}`}
          >
            <AlertCircle size={20} />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {[
          ...
          {
            label: "Avg Monthly (2026)",
            value: fmt(Math.round(avgMonthlyExpense)),
        ...
        <div className="lg:col-span-3 space-y-5">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {(
                ["All", ...EXPENSE_CATEGORIES] as (ExpenseCategory | "All")[]
              ).map((cat) => {
                ...
                const catColor =
                  cat === "All"
                    ? isDark
                      ? "#cbd5e1"
                      : "#475569"
                    : EXPENSE_CATEGORY_COLORS[cat as ExpenseCategory];
              ...
              filteredSorted.map((tx) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `${EXPENSE_CATEGORY_COLORS[tx.category as ExpenseCategory]}20`,
                    }}
                  >
                    <TrendingDown
                      size={20}
